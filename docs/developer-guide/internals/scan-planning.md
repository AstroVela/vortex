...
This initial planner change only constructs, optimizes, and displays physical plan trees. It does
not change layout vtables, layout readers, scan builders, or scan execution. Built-in layouts are
