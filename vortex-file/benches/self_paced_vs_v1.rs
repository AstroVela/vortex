...
async fn trace_cases(requested: &str) -> VortexResult<()> {
    ...
    for (name, selectivity, morsel_rows, concurrency) in TRACE_CASES {
        ...
        println!(
            ...
            result.metrics.demand_fragments,
            result.metrics.fragment_predicates_completed,
            result.metrics.fragment_demand_updates,
            result.metrics.fragment_merge_tasks,
            result.metrics.fragment_projection_reads_unblocked,
            result.metrics.segment_predicates_fused,
            result.metrics.fragment_cached_predicate_hits,
            result.metrics.segment_predicate_eval_ns,
            result.metrics.fragment_demand_adoption_ns,
            result.metrics.fragment_merge_elapsed_ns,
            result.metrics.fragment_reduced_demand_predicates,
            result.metrics.fragment_reduced_demand_input_rows,
            result.metrics.fragment_reduced_demand_skipped_rows,
            result.metrics.fragment_reduced_demand_eval_ns,
            result.trace.len(),
        );
    }
    if !matched {
...
async fn trace_workload(
    ...
    println!(
        ...
        result.metrics.predicate_only_resources,
        result.metrics.projection_only_resources,
        result.metrics.shared_predicate_projection_resources,
        result.metrics.predicate_only_read_bytes,
        result.metrics.projection_only_read_bytes,
        result.metrics.shared_predicate_projection_read_bytes,
        result.metrics.shared_decode_reuse_hits,
        result.metrics.shared_decode_reuse_bytes,
        result.metrics.projection_from_predicate_decode_hits,
        result.metrics.projection_from_predicate_decode_bytes,
        result.metrics.demand_fragments,
        result.metrics.fragment_predicates_completed,
        result.metrics.fragment_demand_updates,
        result.metrics.fragment_merge_tasks,
