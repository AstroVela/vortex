...
public final class VortexPartitionReaderFactory implements PartitionReaderFactory, Serializable {
    ...
    public VortexPartitionReaderFactory(
            List<String> dataColumnNames, Map<String, String> formatOptions, Predicate[] pushedPredicates, int limit) {
    ...
    public PartitionReader<ColumnarBatch> createColumnarReader(InputPartition partition) {
        ...
        return new VortexPartitionReader(spark, dataColumnNames, formatOptions, pushedPredicates, limit);
    }
