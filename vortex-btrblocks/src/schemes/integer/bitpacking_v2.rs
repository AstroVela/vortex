...
/// Whether chunk-wise bit-packing is offered to the compressor.
///
/// [`BitPackedV2`] is a preview encoding, so it stays out of the scheme race unless
/// `VORTEX_BITPACKED_V2=1` is set. Note that a writer additionally has to enable the preview
/// edition for the encoding to reach a file.
pub fn use_bitpacked_v2() -> bool {
    static USE_BITPACKED_V2: LazyLock<bool> =
        LazyLock::new(|| env::var("VORTEX_BITPACKED_V2").is_ok_and(|v| v == "1"));
    *USE_BITPACKED_V2
}
