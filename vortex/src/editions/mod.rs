...
//! facade enables the newest frozen `core` edition, [`crate::editions::CORE_2026_07_1`], and
...
pub use self::core::CORE_2026_07_1;
...
pub const DEFAULT_CORE_EDITION: EditionId = CORE_2026_07_1;
