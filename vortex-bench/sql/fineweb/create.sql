-- FineWeb table registration, the companion of this benchmark's query files.
--
...
-- @engine duckdb
CREATE {object} IF NOT EXISTS fineweb AS SELECT * FROM {read}('{dir}/*.{ext}');

-- @engine datafusion
CREATE EXTERNAL TABLE IF NOT EXISTS fineweb STORED AS {format} LOCATION '{dir}/*.{ext}';
